...
function Previousyearquestionpaper() {
  return (
    <>
        <div className="previous-year-question-paper_container">
          ...
          <div  className="about-area pt-145 pb-155">
            <div  className="container">
                <div  className="col-md-12 panel-body" style={{textAlign: "justify"}}>
                    <h1 style={{color: "#f60"}}>CBSE BOARD PREVIOUS YEAR QUESTION PAPERS</h1>
                    <p>
                      CBSE Previous Year Question Paper for Class 8 to 12 can be of great help for students in achieving good grades in school 
                      examinations. The importance of Previous Year Question Paper cannot be denied if a student wishes to score well in exams. 
                      Solving Previous Year Question Paper helps to enhance problem-solving speed, provides an overall understanding of question 
                      pattern, improves time-management, and boost confidence. We, at <span style={{color: "#007aff"}}>theOnline</span><span style={{color: "#f47629"}}>Gurukul</span> , provide CBSE Previous Year Question Papers 
                      prepared by subject matter experts to improve the academic performance of students.
                    </p>
                    <br />
                    <p>
                    Become a class topper with the best Previous Year Question Paper created by our team of the most experienced 
                    teachers as per the syllabus and the latest exam pattern. The latest sample papers available on 
                    <span style={{color: "#007aff"}}>theOnline</span><span style={{color: "#f47629"}}>Gurukul</span>  website will improve the chances of scoring higher marks in the '2022' final examination
                    </p>
                </div>
            </div>
          </div>
            ...
            <div  className="row clearfix row-spec">
                <div  className="col-xs-12">
                    <div  className="group-title-index">
                        <h2  className="center-title">CLASS WISE PREVIOUS YEAR QUESTION PAPER</h2>
                  ...
                  { syllabusPDFSource.map((Pdfelement,index) => (
                    <div  className="col-md-12"> 
                        <div  className="grid1 grid1-courses" style={{height: "500px"}}>
                            ...
                            <b>
                                <p style={{color: "#f60"}}>
                                Free PDF downloadable link of CBSE previous Year
                                 question papers for each class will help students to perform excellently in exams. They can also join<span style={{color: "#000"}}>theOnline</span>
